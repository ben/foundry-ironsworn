...
- Add Lodestar Expanded Moves and Oracles. ([#1091](https://github.com/ben/foundry-ironsworn/pull/1091)).
- Add "Roll twice" and "Roll three times" functionality to tables. ([#1092](https://github.com/ben/foundry-ironsworn/pull/1092)).
...
- Add item icons for Starforged, Ironsworn and Sundered Isles assets ([#1062](https://github.com/ben/foundry-ironsworn/pull/1062) and [#1064](https://github.com/ben/foundry-ironsworn/pull/1064), thanks [@jendave](https://github.com/jendave)!)
...
- French translation improvements, thanks [@Vilsafur](https://github.com/Vilsafur)! ([#1040](https://github.com/ben/foundry-ironsworn/pull/1040))

## 1.24.10

- Fix an i18n issue with the translation of stats in the pre-roll dialog ([#1039](https://github.com/ben/foundry-ironsworn/pull/1039)) - thanks [@sharak](https://github.com/sharak)!
