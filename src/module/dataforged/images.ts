export const DATAFORGED_ICON_MAP = {
	ironsworn: {
		theme: {
	...
	starforged: {
		foe: {
			...
			'Starforged/Encounters/Chiton/Chiton_Drone_Pack':
				'icons/creatures/invertebrates/spider-large-white-green.webp',
			'Starforged/Encounters/Chiton/Chiton_Queen':
				'icons/creatures/invertebrates/spider-large-white-green.webp',
			'Starforged/Encounters/Colossus':
				'icons/creatures/magical/construct-iron-stomping-yellow.webp',
			'Starforged/Encounters/Colossus/Devotant_of_the_Colossi':
				'icons/creatures/magical/construct-iron-stomping-yellow.webp',
			'Starforged/Encounters/Crystallid':
				'icons/magic/water/ice-crystal-white.webp',
			'Starforged/Encounters/Crystallid/Convergent_Crystallid':
				'icons/magic/water/ice-crystal-white.webp',
			'Starforged/Encounters/Drift_Pirate':
				'icons/skills/trades/profession-sailing-pirate.webp',
			'Starforged/Encounters/Drift_Pirate/Pirate_Boarding_Party':
				'icons/skills/trades/profession-sailing-pirate.webp',
			'Starforged/Encounters/Drift_Pirate/Pirate_Cutlass':
				'icons/skills/trades/profession-sailing-pirate.webp',
			'Starforged/Encounters/Ember_Wisp':
				'icons/magic/light/orbs-smoke-pink.webp',
			'Starforged/Encounters/Ember_Wisp/Wisp_Congregation':
				'icons/magic/light/orbs-smoke-pink.webp',
			'Starforged/Encounters/Firestorm_Trooper':
				'icons/equipment/head/helm-barbute-white.webp',
			'Starforged/Encounters/Firestorm_Trooper/Firestorm_Raiding_Team':
				'icons/equipment/head/helm-barbute-white.webp',
			'Starforged/Encounters/Firestorm_Trooper/Firestorm_Dropship':
				'icons/equipment/head/helm-barbute-white.webp',
			'Starforged/Encounters/Flarewing_Shark':
				'icons/creatures/fish/fish-shark-swimming.webp',
			'Starforged/Encounters/Flarewing_Shark/Mega_Flarewing':
				'icons/creatures/fish/fish-shark-swimming.webp',
			'Starforged/Encounters/Ghost':
				'icons/creatures/magical/spirit-undead-horned-blue.webp',
			'Starforged/Encounters/Ghost/Ghost_Ship':
				'icons/creatures/magical/spirit-undead-horned-blue.webp',
			'Starforged/Encounters/Gnawling':
				'icons/creatures/mammals/rodent-rat-green.webp',
			'Starforged/Encounters/Gnawling/Gnawling_Brood_Mother':
				'icons/creatures/mammals/rodent-rat-green.webp',
			'Starforged/Encounters/Howlcat':
				'icons/creatures/mammals/cat-hunched-glowing-red.webp',
			'Starforged/Encounters/Howlcat/Howlcat_Pack':
				'icons/creatures/mammals/cat-hunched-glowing-red.webp',
			'Starforged/Encounters/Iron_Auger':
				'icons/creatures/fish/squid-kraken-orange.webp',
			'Starforged/Encounters/Iron_Auger/Machine_Mites':
				'icons/creatures/fish/squid-kraken-orange.webp',
			'Starforged/Encounters/Iron_Auger/Planet-Eater':
				'icons/creatures/fish/squid-kraken-orange.webp',
			'Starforged/Encounters/Puppet_Vine':
				'icons/magic/nature/plant-vines-skull-green.webp',
			'Starforged/Encounters/Puppet_Vine/Flowering_Puppet_Vine':
				'icons/magic/nature/plant-vines-skull-green.webp',
			'Starforged/Encounters/Pyralis':
				'icons/creatures/invertebrates/fly-wasp-mosquito-green.webp',
			'Starforged/Encounters/Pyralis/Pyralis_Youngling':
				'icons/creatures/invertebrates/fly-wasp-mosquito-green.webp',
			'Starforged/Encounters/Risen':
				'icons/magic/death/undead-skeleton-rags-fire-green.webp',
			'Starforged/Encounters/Risen/Chimera':
				'icons/magic/death/undead-skeleton-rags-fire-green.webp',
			'Starforged/Encounters/Scrap_Bandit':
				'icons/equipment/head/hat-belted-simple.webp',
			'Starforged/Encounters/Scrap_Bandit/Hover_Prowlers':
				'icons/equipment/head/hat-belted-simple.webp',
			'Starforged/Encounters/Scrap_Bandit/War_Rig':
				'icons/equipment/head/hat-belted-simple.webp',
			'Starforged/Encounters/Servitor':
				'icons/creatures/magical/construct-stone-earth-gray.webp',
			'Starforged/Encounters/Servitor/Enforcer':
				'icons/creatures/magical/construct-stone-earth-gray.webp',
			'Starforged/Encounters/Sicklehorn':
				'icons/creatures/mammals/goat-horned-blue.webp',
			'Starforged/Encounters/Sicklehorn/Sicklehorn_Matriarch':
				'icons/creatures/mammals/goat-horned-blue.webp',
			'Starforged/Encounters/Sicklehorn/Sicklehorn_Stampede':
				'icons/creatures/mammals/goat-horned-blue.webp',
			'Starforged/Encounters/Sky_Roost':
				'icons/magic/nature/root-vine-caduceus-healing.webp',
			'Starforged/Encounters/Sky_Roost/Roost_Swarm':
				'icons/magic/nature/root-vine-caduceus-healing.webp',
			'Starforged/Encounters/Technoplasm':
				'icons/creatures/slimes/slime-movement-pseudopods-blue.webp',
			'Starforged/Encounters/Technoplasm/Infected_Bot':
				'icons/creatures/slimes/slime-movement-pseudopods-blue.webp',
			'Starforged/Encounters/Technoplasm/Scourge_Ship':
				'icons/creatures/slimes/slime-movement-pseudopods-blue.webp',
			'Starforged/Encounters/Void_Shepherd':
				'icons/creatures/fish/fish-bioluminous-blue.webp',
			'Starforged/Encounters/Void_Shepherd/Shepherd_Pod':
				'icons/creatures/fish/fish-bioluminous-blue.webp',
			'Starforged/Encounters/Warden':
				'icons/magic/holy/angel-winged-humanoid-blue.webp',
			'Starforged/Encounters/Warden/Warden_Cohort':
				'icons/magic/holy/angel-winged-humanoid-blue.webp',
			'Starforged/Encounters/Warden/Fury':
				'icons/magic/holy/angel-winged-humanoid-blue.webp',
			'Starforged/Encounters/Water_Witcher':
				'icons/creatures/mammals/elk-moose-marked-green.webp',
			'Starforged/Encounters/Water_Witcher/Dowser':
				'icons/creatures/mammals/elk-moose-marked-green.webp',
			'Starforged/Encounters/Worldbreaker':
				'icons/creatures/abilities/mouth-teeth-rows-white.webp',
			'Starforged/Encounters/Worldbreaker/Worldbreaker_Brood':
				'icons/creatures/abilities/mouth-teeth-rows-white.webp',
			'Starforged/Encounters/Worldbreaker/Elder_Worm':
				'icons/creatures/abilities/mouth-teeth-rows-white.webp'
		}
	}
}
