...
import type { DataModelValidationFailure } from './DataModel'
...
> implements DataField.Options<T>
{
	 ...
	 */
	apply(
		fn: MethodKeys<this, (...args: any[]) => any> | ((...args: any[]) => any),
		value: T,
		options?
	)
	...
	validate: (
		value: unknown,
		options?: DataField.ValidationOptions<T> | undefined
...
export namespace DataField {
	...
	export interface ValidationOptions<TValue = any> {
	...
	export interface Options<TValue = any> {
		...
		validate: (
			value: unknown,
			options?: ValidationOptions<TValue>
