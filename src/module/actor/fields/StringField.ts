 ...
 */
export declare class ColorField extends StringField {}
 ...
 */
export declare class JSONField extends StringField<string, JSONField.Options> {}
 ...
 */
export declare class HTMLField extends StringField<string, HTMLField.Options> {}
