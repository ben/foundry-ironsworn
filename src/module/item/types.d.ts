 ...
 * @public
 */
export declare interface DFGameDataRoot {
	$schema?: string | undefined
	'Asset Types': IAssetType[]
	Encounters: DFIEncounterStarforged[] | DFIEncounterNatureInfo[]
	'Move Categories': IMoveCategory[]
	'Oracle Categories': IOracleCategory[]
	'Setting Truths'?: DFISettingTruth[]
}
 ...
 * @public
 */
export declare interface DFIAlterMomentum {
	/**
 ...
 * @public
 */
export declare interface DFIAlterMomentumBurn {
	/**
 ...
 * @public
 */
export declare interface DFIAlterMomentumReset {
	/**
 ...
 * @public
 */
export declare interface DFIAlterMove
	extends StubBy<
		DFIMove,
		'Trigger' | 'Text',
		'Name' | 'Category' | 'Display' | 'Source' | 'Outcomes' | 'Optional'
	> {
	/**
	 ...
	 * @nullable
	 */
	Moves?: DFIMove['$id'][] | null | undefined
	/**
	...
	/**
	 * The trigger required by the asset ability. If `undefined`, the move alteration applies to all uses of the specified moves, so long as they also meet any implicit asset requirements (fictional framing, `DFIAsset.Requirement`, not being Broken or Out of Action, etc).
	 */
 ...
 * @public
 */
export declare interface DFIAlterMoveOutcomes
	extends Omit<DFIMoveOutcomes, keyof typeof MoveOutcome> {
 ...
 * @public
 */
export declare interface DFIAlterOutcomeInfo
	extends Omit<DFPartialDeep<DFIOutcomeInfo>, 'With a Match'> {
 ...
 * @public
 */
export declare interface DFIAsset
	extends DFIHasId,
		DFIHasName,
		DFIHasDisplay,
		DFIHasSource,
		Partial<DFIHasAliases> {
	/**
 ...
 * @public
 */
export declare interface DFIAssetAbility extends DFIHasId, DFIHasText {
	/**
 ...
 *
 * @example An `IAssetAlterProperties` that would set `DFIAsset["Condition Meter"].Max` to 3, and leave its other properties unchanged:
 * ```javascript
 * { "Condition Meter": { Max: 3 } }
 * ```
 * @public
 */
export declare interface DFIAssetAlterProperties
	extends DFPartialDeep<DFIAsset> {}
 ...
 * @public
 */
export declare interface DFIAssetAttachment {
	/**
 ...
 * @public
 */
export declare interface DFIAssetState extends DFIHasName {
	/**
 ...
 * @public
 */
export declare interface DFIAssetType
	extends DFIHasName,
		DFIHasId,
		DFIHasDescription,
		DFIHasDisplay,
 ...
 * @public
 */
export declare interface DFIAssetUsage {
	/**
...
*/
export declare interface DFIAttribute {
	Key: AttributeKey
 ...
 * @public
 */
export declare interface DFIAttributeChoices {
	Key: AttributeKey
 ...
 * @public
 */
export declare interface DFIConditionMeter extends DFIMeterBase {
	/**
 ...
 * @public
 */
export declare interface DFICustomStat extends DFIHasId, DFIHasName {
	/**
 ...
 * @public
 */
export declare interface DFICustomStatOption extends DFIHasId, DFIHasName {
	/**
 ...
 * @public
 */
export declare interface DFICyclopediaEntry
	extends DFIHasName,
		DFIHasId,
		DFIHasDisplay,
		DFIHasDescription,
		DFIHasSource,
		Partial<DFIHasSummary & DFIHasQuestStarter & DFIHasTags> {
	/**
 ...
 * @public
 */
export declare interface DFIDelveCard
	extends DFIHasName,
		DFIHasSource,
		DFIHasSummary,
		DFIHasDescription,
 ...
 * @public
 */
export declare interface DFIDelveDomain extends DFIDelveCard {
	/**
 ...
 * @public
 */
export declare interface DFIDelveTheme extends DFIDelveCard {
	/**
 ...
 * @public
 */
export declare interface DFIDisplay {
	/**
 ...
 * @public
 */
export declare interface DFIDisplayOracle extends DFIDisplayWithTitle {
	Title: string
	/**
	 ...
	 */
	'Column of'?: DFIOracle['$id'] | undefined
	/**
	 ...
	 */
	'Embed in'?: DFIRow['$id'] | undefined
}

/**
 * @public
 */
export declare interface DFIDisplayWithTitle extends DFIDisplay {
	Title: string
}
 ...
 * @public
 */
export declare interface DFIEncounter extends DFIEncounterBase {
	Features: string[]
	Drives: string[]
	Tactics: string[]
 ...
 * @see {@link DFIEncounter}, {@link IEncounterVariant}
 * @public
 */
export declare interface DFIEncounterBase extends DFICyclopediaEntry {
	/**
 ...
 * @public
 */
export declare interface DFIEncounterIronsworn extends DFIEncounter {
	/**
 ...
 * @public
 */
export declare interface DFIEncounterNatureInfo
	extends DFIHasDescription,
		DFIHasSource,
		DFIHasName,
		DFIHasId,
		DFIHasDisplay,
 ...
 * @public
 */
export declare interface DFIEncounterStarforged extends DFIEncounter {
	/**
 ...
 * @public
 */
export declare interface DFIEncounterVariant
	extends StubBy<
		DFIEncounterStarforged,
		never,
		| 'Features'
		| 'Drives'
		| 'Tactics'
	 ...
	 */
	$id: string
	'Variant of': DFIEncounterStarforged['$id']
}
 ...
 * @public
 */
export declare interface DFIGameObject {
 ...
 * @public
 */
export declare interface DFIHasAliases {
	/**
 ...
 * @public
 */
export declare interface DFIHasDescription {
	/**
 ...
 * @public
 */
export declare interface DFIHasId {
	/**
 ...
 * @public
 */
export declare interface DFIHasQuestStarter {
	/**
 ...
 * @public
 */
export declare interface DFIHasRequirements {
	/**
 ...
 * @deprecated Currently only used by setting truths. If you need to denote a subtable, use the `Oracle rolls` property to point to an `DFIOracle` in the `Oracles` property of this table's parent.
 * @public
 */
export declare interface DFIHasSubtable {
	Subtable: DFIRow[]
}
 ...
 * @public
 */
export declare interface DFIHasSummary {
	/**
	 * A user-facing markdown summary of the item. `Summary` is shorter than {@link DFIHasDescription | Description}.
	 * @markdown
	 */
	Summary: string
}
 ...
 * @public
 */
export declare interface DFIHasTable {
	Table: DFIRow[]
}
 ...
 * @public
 */
export declare interface DFIHasTags {
	/**
 ...
 * @public
 */
export declare interface DFIInput extends DFIHasId, DFIHasName {
	/**
 ...
 * @public
 */
export declare interface DFIInputClock extends DFIInput {
 ...
 * @public
 */
export declare interface DFIInputNumber extends DFIInput {
 ...
 * @public
 */
export declare interface DFIInputSelect extends DFIInput {
 ...
 * @public
 */
export declare interface DFIInputSelectAttributeDefinition {
	Key: string
 ...
 * @public
 */
export declare interface DFIInputSelectOption extends DFIHasId, DFIHasName {
	/**
 ...
 * @public
 */
export declare interface DFIInputSelectOptionSetter extends DFIHasId {
	/**
 ...
 * @public
 */
export declare interface DFIInputSelectOptionSetterMeter
	extends DFIInputSelectOptionSetter {
 ...
 * @public
 */
export declare interface DFIInputSelectOptionSetterNumber
	extends DFIInputSelectOptionSetter {
 ...
 * @public
 */
export declare interface DFIInputSelectOptionSetterStat
	extends DFIInputSelectOptionSetter {
 ...
 * @public
 */
export declare interface DFIInputSelectOptionSetterString
	extends DFIInputSelectOptionSetter {
 ...
 * @public
 */
export declare interface DFIInputText extends DFIInput {
 ...
 * @public
 */
export declare interface DFIIronswornRegion extends DFICyclopediaEntry {
	/**
 ...
 * @public
 */
export declare interface DFIMeterBase extends DFIHasId, DFIHasName {
	/**
 ...
 * @public
 */
export declare interface DFIMoveCategory
	extends DFIHasId,
		DFIHasName,
		DFIHasSource,
		DFIHasDescription,
 ...
 * @public
 */
export declare interface DFIMoveOutcomes extends DFIHasId {
	/**
	 ...
	 */
	$id: string
	'Strong Hit': DFIOutcomeInfo
	'Weak Hit': DFIOutcomeInfo
	Miss: DFIOutcomeInfo
}
 ...
 * @public
 */
export declare interface DFIMoveReroll extends Partial<DFIHasText> {
	/**
 ...
 * @public
 */
export declare interface DFIMoveTriggerBy {
	/**
...
/**
 * Describes {@link DFIRow} results that call for multiple rolls, most commonly "Roll twice" results.
 * @public
 */
export declare interface DFIMultipleRolls {
	/**
	 ...
	 *
	 * Typically this is accompanied by `DFIRow.Result` text like "Roll twice more on this table. Both results occur. If they are the same result, make it worse."
	 *
 ...
 *
 * But if for some reason you can't, you can use this interface to type both {@link DFIOracle} and {@link IOracleCategory} as you recurse the oracle hierarchy. Objects with `Categories` and `Oracles` are "branches", and objects with `Table` are "leaves".
 * @public
 */
export declare interface DFIOracleBase
	 ...
	 *
	 * This key appears only on 'branch' nodes of the oracle hierarchy 'tree': {@link IOracleCategory}, and {@link DFIOracle} (when it contains multiple closely-related tables).
	 */
...
/**
 * Represents an oracle category: a grouping that can contain both {@link DFIOracle}s and other instances of {@link IOracleCategory}, but doesn't have its own `Table` key.
 *
 * If you're looking for a way to crawl the oracle hierarchy in search of a specific ID, see {@link DFIOracleBase}.
 *
 * @public
 */
export declare interface DFIOracleCategory extends DFIOracleBase {
	/**
	 * @pattern ^(Ironsworn|Starforged)/Oracles/[A-z_-]+(/[A-z_-]+)?$
	 */
	$id: string
 ...
 * @public
 */
export declare interface DFIOracleContent {
	/**
 ...
 * @public
 */
export declare interface DFIOracleMatch extends DFIHasId, DFIHasText {
	/**
 ...
 * @public
 */
export declare interface DFIOracleUsage
	extends Partial<DFIHasRequirements & DFIHasSuggestions & DFIHasRollTemplate> {
	/**
 ...
 * @public
 */
export declare interface DFIRequirements {
	/**
 ...
 * @public
 */
export declare interface DFIRollColumn extends DFITableColumnBase {}
 ...
 * @public
 */
export declare interface DFIRollTemplate {
	/**
 ...
 * @public
 */
export declare interface DFIronsworn extends DFGameDataRoot {
	Encounters: DFIEncounterNatureInfo[]
	'Setting Truths'?: DFISettingTruth[]
}
 ...
 * @public
 */
export declare interface DFISettingTruth
	extends DFIHasId,
		DFIHasName,
		DFIHasSource,
		DFIHasDisplay,
 ...
 * @public
 */
export declare interface DFISettingTruthOptionSubtableRow extends DFIRow {
	/**
 ...
 * @public
 */
export declare interface DFISuggestions {
	/**
	 ...
	 * Suggested move IDs.
	 */
	Moves?: DFIMove['$id'][] | undefined
	/**
	 * Suggested asset IDs.
	 */
	Assets?: DFIAsset['$id'][] | undefined
	/**
	 * Suggested encounter IDs.
	 */
	Encounters?: DFIEncounterStarforged['$id'][] | undefined
}
 ...
 * @public
 */
export declare interface DFITableColumnBase {
	Label: string
	/**
	 * The ID of the oracle table to use.
	 */
	'Use content from': DFIOracle['$id']
}
 ...
 * @public
 */
export declare interface DFITableDisplayInfo {
	'Result columns': ITextColumn[]
	'Roll columns': DFITableColumnBase[]
}
 ...
 * @public
 */
export declare interface DFITextColumn extends DFITableColumnBase {
	/**
 ...
 * @public
 */
export declare interface DFStarforged extends DFGameDataRoot {
	Encounters: DFIEncounterStarforged[]
	'Setting Truths': DFISettingTruth[]
}
