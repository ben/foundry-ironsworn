...
interface RenderData {
	...
	adds: Array<SourcedValue<number | string>>
	...
	challengeDice: Array<Partial<SourcedValue & { minmax?: 'min' | 'max' }>>
...
export async function renderRollGraphic(opts: RollGraphicRenderOpts) {
	...
	if (opts.roll.finalChallengeDice != null) {
