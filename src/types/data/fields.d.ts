...
type InitialType<T> =
	...
	| null
	| undefined
	| ((initialData: unknown) => T | null | undefined)
...
export declare namespace DataField {
	...
	export type InitialTypeFor<Field extends Any> =
		Field['initial'] extends () => infer R ? R : Field['initial']

	export type InitializedTypeFor<Field extends Any> =
		InternalInitializedTypeFor<Field, ExtendsOptionsFor<Field>>

	type InternalInitializedTypeFor<
		Field extends Any,
		ExtendsOptions extends AnyExtendsOptions
	> = ExtendsOptions['InitializedType'] | ExtraTypes<Field>

	export type SourceTypeFor<Field extends Any> = InternalSourceTypeFor<
		Field,
		ExtendsOptionsFor<Field>
	>

	type InternalSourceTypeFor<
		Field extends Any,
		ExtendsOptions extends AnyExtendsOptions
	> =
	...
	export type OptionsFor<Field extends typeof DataField> =
		Field extends abstract new (...args: any[]) => DataField<infer Options, any>
			? Options
			: never
	...
	export type ExtendsOptionsFor<Field extends Any> = Field extends DataField<
		infer Options,
	...
	export type ExtendsOptions<
		...
		DefaultOptionsValue extends DataField.DefaultOptions<SourceType> &
			InexactPartial<ExtraOptions>,
	...
	> = {
		...
		DefaultOptionsValue: IsAny<DefaultOptionsValue> extends true
...
export namespace BooleanField {
	...
	export type ExtendsOptions = DataField.ExtendsOptions<
		BooleanField.Type,
		BooleanField.DefaultOptionsValue
	>
}
...
export type DataFieldChoicesOptions<Choices extends DataFieldChoices<any>> =
		...
		[Choices] extends [undefined]
			? 'choices' extends keyof ExtendsOptions['DefaultOptionsValue']
				? Extract<
						...
						DataFieldChoices<any> | undefined
				  >
				: undefined
			: Choices
	>
...
type CalculateChoicesMerge<Choices extends DataFieldChoices<any> | undefined> =
	Choices extends unknown
		? Choices extends undefined
			? { choices?: undefined }
			: {
					choices: Choices
					initial?: InitialType<
						DataFieldChoicesOptions<Exclude<Choices, undefined>>
					>
			  }
		: never
...
export namespace NumberField {
	...
	export type ExtendsOptions<
		Choices extends DataFieldChoices<NumberField.Type> | undefined
	> = SimpleMerge<
...
export declare class NumberField<
	Options extends ChoicesOptions<
		ExtendsOptions,
		CoalesceUnknown<Choices, undefined>
	>,
	Choices extends
		| DataFieldChoices<ExtendsOptions['SourceType']>
		| undefined = Options['choices'],
	ExtendsOptions extends DataField.AnyExtendsOptions = NumberField.ExtendsOptions<
		CoalesceUnknown<Choices, undefined>
	>
...
export declare class StringField<
	...
	Choices extends
		| DataFieldChoices<ExtendsOptions['SourceType']>
		| undefined = Options['choices'],
	ExtendsOptions extends DataField.AnyExtendsOptions = StringField.ExtendsOptions<
		CoalesceUnknown<Choices, undefined>
	>
> extends DataField<Options, ExtendsOptions> {
...
export declare namespace ArrayField {
	...
	export type AnyExtendsOptions = DataField.ExtendsOptions<
		any,
		any,
		any,
		any
...
export declare class ArrayField<
	...
	ExtendsOptions extends ArrayField.AnyExtendsOptions = SimpleMerge<
		ArrayField.ExtendsOptions<
			DataField.Any,
			Expand<DataField.SourceTypeFor<InputElement>>
		>,
		{
...
> extends DataField<Options, ExtendsOptions> {
	...
	_cast(
		value:
			| ArrayElement<DataField.SourceTypeFor<this>>
	...
	protected _validateElements(
		value: ExtendsOptions['InputElement'][],
		options: Record<string, unknown>
	): Error[]
...
export declare namespace SetField {
	...
	export type ExtendsOptions<Field extends DataField.Any> = SimpleMerge<
		ArrayField.ExtendsOptions<
			DataField.Any,
			DataField.ExtendsOptionsFor<Field>['SourceType']
		>,
		{
			InputElement: DataField.Any
			InitializedType: Set<
				DataField.ExtendsOptionsFor<Field>['InitializedType']
			>
		}
	>
}
...
export declare namespace EmbeddedDataField {
	...
	> &
		(new <Parent extends AnyDocument | null>(
			data?: any,
			context?: Context<any>
		) => DataModel.Any)

	export type ExtendsOptions<Model extends DataModelConstructor> =
		SchemaField.ExtendsOptions<ReturnType<Model['defineSchema']>>
}
...
export declare namespace ForeignDocumentField {
	export type Type = Pick<typeof DataModel, keyof typeof DataModel> &
		(abstract new <Parent extends DataModel.Any>(
			data?: any,
			context?: Context<any>
		) => DataModel.Any)
	...
	export type ExtendsOptions<
		Model extends Type,
		Options extends DataField.Options<any>
	> = SimpleMerge<
		DocumentIdField.ExtendsOptions,
		{
			...
			InitializedType: GetKey<Options, 'idOnly'> extends true
				? string
				: InstanceType<Model>
		}
	>
...
export declare class ForeignDocumentField<
	...
	Options extends DataField.Options<ExtendsOptions>,
	ExtendsOptions extends DataField.AnyExtendsOptions = ForeignDocumentField.ExtendsOptions<
		Model,
		Options
	>
...
export declare namespace SystemDataField {
	...
	export type ExtendsOptions<
		ConcreteDocument extends DocumentConstructor & {
			metadata: { name: SystemDocumentType }
		}
	> = SimpleMerge<
		ObjectField.ExtendsOptions,
		{
...
> extends ObjectField<Options, ExtendsOptions> {
	 ...
	 */
	getModelForType<
		SubType extends keyof SystemConfig[ConcreteDocument['metadata']['name']]
	>(
		type: SubType
...
export declare namespace ColorField {
	...
	export type ExtendsOptions<
		Choices extends DataFieldChoices<ColorField.Type> | undefined
	> = SimpleMerge<
...
export declare class ColorField<
	...
	>,
	Choices extends
		| DataFieldChoices<ColorField.Type>
		| undefined = Options['choices'],
	ExtendsOptions extends DataField.AnyExtendsOptions = ColorField.ExtendsOptions<
		CoalesceUnknown<Choices, undefined>
	>
...
export declare namespace FilePathField {
	...
	export type ExtendsOptions<
		Choices extends DataFieldChoices<FilePathField.Type> | undefined
	> = SimpleMerge<
		StringField.ExtendsOptions<Choices>,
		{
			DefaultOptionsValue: DefaultOptionsValue
...
export declare class FilePathField<
	...
	>,
	Choices extends
		| DataFieldChoices<FilePathField.Type>
		| undefined = Options['choices'],
	ExtendsOptions extends DataField.AnyExtendsOptions = FilePathField.ExtendsOptions<
		CoalesceUnknown<Choices, undefined>
	>
> extends StringField<Options, Choices, ExtendsOptions> {
...
export declare namespace AngleField {
	...
	export type ExtendsOptions<
		Choices extends DataFieldChoices<AngleField.Type> | undefined
	> = SimpleMerge<
...
export declare class AngleField<
	...
	>,
	Choices extends
		| DataFieldChoices<AngleField.Type>
		| undefined = Options['choices'],
	ExtendsOptions extends DataField.AnyExtendsOptions = AngleField.ExtendsOptions<
		CoalesceUnknown<Choices, undefined>
	>
...
export namespace AlphaField {
	...
	export type ExtendsOptions<
		Choices extends DataFieldChoices<AlphaField.Type> | undefined
	> = SimpleMerge<
		NumberField.ExtendsOptions<Choices>,
		{
			DefaultOptionsValue: DefaultOptionsValue
...
export declare class AlphaField<
	...
	>,
	Choices extends
		| DataFieldChoices<AlphaField.Type>
		| undefined = Options['choices'],
...
export declare class JSONField<
	...
	Choices extends
		| DataFieldChoices<ExtendsOptions['SourceType']>
		| undefined = Options['choices'],
	ExtendsOptions extends DataField.AnyExtendsOptions = JSONField.ExtendsOptions<
		CoalesceUnknown<Choices, undefined>
	>
> extends StringField<Options, Choices, ExtendsOptions> {
	override clean(
...
export namespace HTMLField {
	...
	export type ExtendsOptions<
		Choices extends DataFieldChoices<HTMLField.Type> | undefined = undefined
	> = SimpleMerge<
		StringField.ExtendsOptions<Choices>,
		{
			DefaultOptionsValue: DefaultOptionsValue
...
export declare class HTMLField<
	...
	>,
	Choices extends
		| DataFieldChoices<HTMLField.Type>
		| undefined = Options['choices'],
	ExtendsOptions extends DataField.AnyExtendsOptions = HTMLField.ExtendsOptions<
		CoalesceUnknown<Choices, undefined>
	>
> extends StringField<Options, Choices, ExtendsOptions> {}
...
export function systemDataField<
	Document extends DocumentConstructor & {
		metadata: { name: SystemDocumentType }
	}
>(document: Document): SystemDataField<Document, {}>
...
export function foreignDocumentField<
	...
	Options extends DataField.Options<
		ForeignDocumentField.ExtendsOptions<Model, Options>
	> & {
		type: {
			model: Model
		}
...
export function embeddedCollectionField<
	...
	Options extends DataField.Options<
		EmbeddedCollectionField.ExtendsOptions<ConcreteDocumentConstructor>
	>
>(
